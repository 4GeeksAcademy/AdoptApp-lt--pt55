...
class User(db.Model):
    ...
    publications: Mapped[list[Publication]] = relationship("Publication", back_populates="user", foreign_keys="Publication.user_id")
    adoptions: Mapped[list[Publication]] = relationship("Publication", back_populates="adopter", foreign_keys="Publication.adopter_id")
...
class Publication(db.Model):
    ...
    adopter: Mapped[User] = relationship("User", back_populates="adoptions", foreign_keys=[adopter_id])
    media: Mapped[list[Media]] = relationship("Media", back_populates="publication")
...
class Media(db.Model):
    ...
    file_type: Mapped[FileTypeEnum] = mapped_column(Enum(FileTypeEnum), nullable=False)
    url: Mapped[str] = mapped_column(String(260), nullable=False)

    publication: Mapped[Publication] = relationship("Publication", back_populates="media")
